 ...
 *
 * Local change (tonbo): ASCII-only strcasestr shim for Win32/MinGW,
 * which lacks the POSIX strcasestr(). Also avoids locale dependence.
 */
...
#if defined(_WIN32)
/* ASCII case-insensitive substring search (locale-independent). */
